...
public class MeshData : MonoBehaviour
{
    ...
    public static readonly Vector3[] wallVerts =
    {
        new Vector3(0.0f, 0.0f, 0.0f),
        new Vector3(1.0f, 0.0f, 0.0f),
        new Vector3(1.0f, 1.0f, 0.0f),
    ...
    public static readonly int[,] wallTris =
    {
        {0, 3, 1, 1, 3, 2}, // Front Face
        {5, 6, 4, 4, 6, 7}, // Back Face
        {4, 7, 0, 0, 7, 3}, // Left Face
    ...
    public static readonly Vector2[] wallUvs =
    {
        new Vector2(0.0f, 0.0f),
        new Vector2(1.0f, 0.0f),
        new Vector2(0.0f, 1.0f),
    ...
    public static readonly Vector3[] roomVerts =
    {
        new Vector3(0.0f, 0.0f, 0.0f),
        new Vector3(1.0f, 0.0f, 0.0f),
        new Vector3(1.0f, 1.0f, 0.0f),
    ...
    public static readonly int[,] roomTris =
    {
    ...
    public static readonly Vector2[] roomUvs =
    {
        new Vector2(1.0f, 0.0f),
        new Vector2(0.0f, 0.0f),
        new Vector2(1.0f, 1.0f),
