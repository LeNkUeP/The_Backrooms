...
public class RandomRoomNew : DefaultRoomImpl
{
    public override void buildDoorways(Level_0_Generator Level_0)
    {
        ...
        // no doors possible with set parameters -> no doorways
        ...
        for (int side = 0; side < 4; side++)
        {
            ...
            if (!hasNoWall)
            {
                ...
                for (int i = 0; i < numberOfDoors; i++)
                {
                    ...
                    if (maxPossibleDoorWidth > Level_0.maximalDoorWidth)
                    {
                        maxPossibleDoorWidth = Level_0.maximalDoorWidth;
                    }
